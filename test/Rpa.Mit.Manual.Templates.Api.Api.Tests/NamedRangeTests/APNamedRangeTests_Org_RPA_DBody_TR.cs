...
{
    public class APNamedRangeTests_Org_RPA_DBody_TR : BaseAPTests
    {
        ...
        public void MainAccount()
        {
            ...
            Assert.Equal("TRAPAccounts", namedRange);
        }
        ...
        public void Scheme()
        {
            ...
            Assert.Equal("TRSchemes", namedRange);
        }
